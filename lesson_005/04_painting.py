...
from lesson_005.animation_painting.snowfall import snowfall_draw
from lesson_005.drawing_old_pictures.rainbow import rainbow_picture
from lesson_005.drawing_old_pictures.street import street_draw
...
while True:
    ...
    rainbow_picture(x_center=420, y_center=150, radius=800, first_color=first_color);first_color = (first_color + 1) % 7
    ...
    street_draw(X_SIZE, 200)
    smile_draw(x_strart=x_start_for_kolobok, y_start=150); x_start_for_kolobok += 5
